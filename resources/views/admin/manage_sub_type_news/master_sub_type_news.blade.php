      ...
      @endif
        <div class="box box-default collapsed-box box-solid">
          <div class="box-header with-border">
            <h3 class="box-title">Master Sub Type News</h3>
            <div class="box-tools pull-right">
              <button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-plus"></i></button>
            </div><!-- /.box-tools -->
          </div><!-- /.box-header -->
            <div class="box-body">
              <form method="POST"  action="{{ url('manage_sub_type_news/add_sub_type_news') }}" enctype="multipart/form-data">
                <div class="row">
                  ...
                  <div class="col-xs-6 col-md-4">
                    <label for="exampleInputPassword1">Select Type News</label>
          ...
          <div class="row">
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header"><h4>Data Sub Type</h4></div>
                    ...
                    <tbody>
                      ...
                      @foreach($sub_type_newss as $subtype)
                        <tr>
                          ...
                          <td>
                            <?php
                              $date = strtotime($subtype->created_date);
                          ...
                          <td>
                            <?php
                              $date = strtotime($subtype->updated_at);
                              echo date("d-m-Y H:i", $date);
                            ?>
                          </td>
                          <td>
                            <a href="{{ url('manage_sub_type_news/edit_sub_type_news/'.$subtype->id)}}"><button style="width:90px;" type="button" class="btn btn-info">Edit</button></a>
                          </td>
                          <td>
                            <form style="display: inline-table;" method="POST" action="{{ url('manage_sub_type_news/delete_sub_type_news') }}">
                              ...
                              <input type="hidden" name="_token" value="{{ csrf_token() }}">
                              <button style="width:90px;" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this Sub Type ?')" type="submit">Delete</button>
                            </form>
                          </td>
                        </tr>
                      @endforeach
