    ...
    <div class="wrapper">
      ...
      @endif
        <div class="row">
          <div class="col-xs-12">
            <div class="box">
              <div class="box-header"><h4>Data My Post</h4></div>
                ...
                <tbody>
                  ...
                  @foreach($posts->subtypenews as $sub)
                    <tr>
                      ...
                      <td>
                        <a href="{{ url('manage_post/edit_post/'.$posts->id) }}"><button style="width:90px;" type="button" class="btn btn-info">Edit</button></a>
                      </td>
                      <td>
