                ...
                <form method="POST"  action="{{ url('manage_post/update_post') }}" enctype="multipart/form-data">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      @else
                      <span style="padding: 0 0 10px 200px;">Upload headline now!</span>
                    </div>
                    @endif
                    <div class="form-group">
                    ...
                    <div style="padding:20px 15px 0 0;" class="pull-right">
                      <button style="width:150px;" type="submit" name="choose" value="suspend" class="btn btn-danger">Suspend News</button>
