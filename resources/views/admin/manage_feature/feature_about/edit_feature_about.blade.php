      ...
      @endif
        ...
        <div class="box box-default collapsed-box box-solid">
          <div class="box-header with-border">
            <h3 class="box-title">Edit Feature About</h3>
            <div class="box-tools pull-right">
              <button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-plus"></i></button>
            </div><!-- /.box-tools -->
          </div><!-- /.box-header -->
          <div class="box-body">
            <form method="POST"  action="{{ url('manage_feature/feature_about/update') }}" enctype="multipart/form-data">
              <div class="row">
                    <img style="padding: 0 0 10px 200px; max-height: 350px;" src="{{ url('header_about/'.$edit->header_about) }}">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <div class='input-group date' id='datetimepicker1'>
                          <input type='text' name="created_date" value="{{$edit->created_date}}" class="form-control _date" required/>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <textarea class="form-control ckeditor" id="editor1" name="text_about" placeholder="Content" class="materialize-textarea" rows="6" required/>{{$edit->text_about}}</textarea>
                      </div>
                    </div>
                    ...
                    <div style="padding:20px 15px 0 0;" class="pull-right">
                      <button style="width:150px;" type="submit" name="choose" value="draft" class="btn btn-primary">Update and Publish</button>
                    </div>
                  ...
                  <tbody>
                    ...
                    @foreach($fabout as $about)
                      <tr>
                        ...
                        <td>
                          <a href="{{ url('manage_type_news/edit_type_news/'.$about->id)}}"><button style="width:90px;" type="button" class="btn btn-info">Edit</button></a>
                        </td>
                        <td>
